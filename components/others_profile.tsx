...
import { View, Text, Image, StyleSheet, TouchableOpacity, Alert, ScrollView, Dimensions, RefreshControl, FlatList, Linking } from 'react-native';
...
const ProfileComponent = ({ navigation, route }: any) => {
    ...
    const [Push_ups, setPush_ups] = useState('')
    const [bench_press, setBench_press] = useState('')
    const [dead_lift, setDead_lift] = useState('')
    ...
    useEffect(() => {
        ...
        const getdata = async () => {
            ...
            let username = route.params.usename;
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch(`${API_HOST}/userimages?page=${page}&is_other_user='true'&user=${username}`, {
                    method: 'get',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Token ${await AsyncStorage.getItem('@token')}`,
                ...
                <View style={styles.profileHeader}>
                    ...
                    <View style={styles.profileDetails}>
                        ...
                        <View style={styles.profileButtons}>
                            ...
                            <TouchableOpacity onPress={() => { navigation.navigate('login'); }} style={styles.first_buttons}>
